...
public class UpdateEssentialTarget {
	...
	public UpdateEssentialTarget() {
	}

	public UpdateEssentialTarget(String shopId, String category, String brand, String location, String phone) {
		this.shopId = shopId;
